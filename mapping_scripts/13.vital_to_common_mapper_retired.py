...
try:
    ...
    for folder in folders :
        ...
        vital_input_path = f'/app/data/{input_data_folder}/pcornet_tables/{folder}/VITAL.csv'

        vital_id_to_omop_id_mapping_path          = f'/app/data/{input_data_folder}/mapping_tables/{folder}/mapping_vitalid_to_omop_id.csv'

        encounterid_to_visit_occurrence_id_mapping_path   = f'/app/data/{input_data_folder}/mapping_tables/{folder}/mapping_encounterid_visit_occurrence_id.csv'
        ...
        vital                                     = cf.spark_read(vital_input_path,spark)
        ...
        cf.write_pyspark_output_file(
                        ...
                        output_file_name = "common_from_vital.csv",
