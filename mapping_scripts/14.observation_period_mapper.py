...
try:
    ...
    for folder in folders :
        ...
        enrollment_input_path                            = f'/app/data/{input_data_folder}/pcornet_tables/{folder}/ENROLLMENT/ENROLLMENT.csv*'
        enrollment_files = sorted(glob.glob(enrollment_input_path))
        ...
        mapped_data_folder_path                           = f'/app/data/{input_data_folder}/omop_tables/{folder}/observation_period/'
        ...
        for enrollment_file in enrollment_files:
                counter =  counter + 1
                enrollment                                     = cf.spark_read(enrollment_file, spark)
                suffix = enrollment_file.rsplit(".", 1)[-1]
        ...
        ###################################################################################################################################
                ...
                files_count = len(enrollment_files)
                current_count= counter
                file_name = f"observation_period.csv.{suffix}"
